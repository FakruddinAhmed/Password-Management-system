...
Public Class DataAccessLayer
    ...
    Public Function GetAccountNames(userID As Integer) As List(Of String)
        Dim accountNames As New List(Of String)()

        Try
            Dim query As String = "SELECT AccountName FROM Accounts WHERE UserID = @UserID"
        ...
        Catch ex As Exception
            ' Handle exception
            MessageBox.Show($"Error retrieving account names: {ex.Message}")
        End Try
