...
Public Class Form1
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Dim enteredUsername = TextBox1.Text
        Dim enteredPassword = TextBox2.Text

        ' Validate credentials
        If ValidateCredentials(enteredUsername, enteredPassword) Then
            ' Successful login, open the main form with the user ID
            Dim authenticatedUserID = GetUserIDByUsername(enteredUsername)
    ...
    Private Sub Label4_Click(sender As Object, e As EventArgs) Handles Label4.Click
        Dim contactUsForm As New Contactform()
        contactUsForm.Show()
        Me.Hide()
    End Sub
End Class
